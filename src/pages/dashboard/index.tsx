...
export function Dashboard() {
  ...
  return (
    <Container>
      ...
      <main className="grid grid-cols-3 gap-5 md:grid-cols-2 lg:grid-cols-3">
        {cars.map(car => ( 
          <section key={car.id} className="w-full bg-white rounded-lg relative">
          <button 
            onClick={() => handleDeleteCar(car)}
            className="absolute bg-white hover:bg-gray-400 transition-all duration-300 w-14 h-14 rounded-full flex items-center justify-center right-2 top-2 ">
